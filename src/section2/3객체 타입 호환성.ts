...
// 결론적으로 내가 생각하는 객체 타입 호환성 보는 방법은 필수 멤버가 서로 같은지 확인하고 만약에 A는 2개에서 끝이고
// B는 3개의 필수 멤버가 있다면 없으니까 할당할 수 없다고 생각함 없기 때문에 A는 B에 할당할 수 없고
// B는 있기 때문에 B는 A에 할당가능하다고 생각해서 외움
